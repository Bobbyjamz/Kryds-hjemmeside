...
const SERVICE_TILES = [
  ...
  { cat: "Havearbejde",          num: "03", labelKey: "mob_tile_3_label", subKey: "mob_tile_3_sub", count: "28", img: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=900&q=80", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F5C400" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2C8 6 6 10 6 14a6 6 0 0 0 12 0c0-4-2-8-6-12z"/><path d="M12 14v8"/></svg> },
  { cat: "Montering",            num: "04", labelKey: "mob_tile_4_label", subKey: "mob_tile_4_sub", count: "41", img: "https://images.unsplash.com/photo-1572297794422-b02f9eafd1b6?w=900&q=80", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F5C400" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.8-3.8a6 6 0 0 1-7.9 7.9l-6.9 6.9a2.1 2.1 0 0 1-3-3l6.9-6.9a6 6 0 0 1 7.9-7.9l-3.8 3.8z"/></svg> },
  { cat: "Nedrivning & rydning", num: "05", labelKey: "mob_tile_5_label", subKey: "mob_tile_5_sub", count: "19", img: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=900&q=80", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F5C400" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 20l9-9M11 11l6-6 4 4-6 6zM13 13l5 5"/></svg> },
  { cat: "Flise & anlæg",        num: "06", labelKey: "mob_tile_6_label", subKey: "mob_tile_6_sub", count: "22", img: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&q=80", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F5C400" strokeWidth="2" strokeLinecap="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg> },
  { cat: "Byggepladsbehjælp",    num: "07", labelKey: "mob_tile_7_label", subKey: "mob_tile_7_sub", count: "37", img: "https://images.unsplash.com/photo-1590725121839-892b458a74fe?w=900&q=80", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F5C400" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 21h18M5 21V7l7-4 7 4v14M9 9h6M9 13h6M9 17h6"/></svg> },
