...
export default function StatsBar() {
  ...
  return (
    <div ref={ref}>
      <div className="reveal bg-gray px-[52px] py-7 flex gap-0 border-b border-[rgba(242,238,230,0.07)] max-[900px]:px-5 max-[900px]:flex-col">
        {stats.map((s, i) => (
          <div
            key={i}
            className={`flex-1 flex flex-col gap-1 px-8 max-[900px]:px-0 max-[900px]:py-[14px] ${
              i < stats.length - 1
                ? "border-r border-[rgba(242,238,230,0.07)] max-[900px]:border-r-0 max-[900px]:border-b"
                : ""
            } ${i === 0 ? "pl-0" : ""}`}
          >
