...
export const translations: Record<Lang, Record<string, string>> = {
  da: {
    ...
    svc_1_desc:
      "Grundig rengøring, oprydning og istandsættelse til hjem, kontor og byggeplads.",
    svc_1_tags: "Rengøring · Oprydning · Istandsættelse · Kontorrengøring",
    svc_2_title: "Flytning & Transport",
    svc_2_desc:
      "Hjælp til flytning, møbeltransport og tunge løft. Vi pakker, bærer og sætter op.",
    svc_2_tags: "Flytning · Transport · Pakning · Tunge løft",
    svc_3_title: "Maling & Spartling",
    svc_3_desc:
      "Malere og hjælpere til alle typer malerarbejde — vægge, lofter, facader og trapper.",
    svc_3_tags: "Indendørs · Facade · Spartling · Grundning",
    svc_4_title: "Montering & Samling",
    svc_4_desc:
      "Erfarne folk til montering af køkkener, badeværelser, møbler og inventar.",
    svc_4_tags: "Køkken · Møbler · Badeværelse · Inventar",
    svc_5_title: "Have & Anlæg",
    svc_5_desc:
      "Havefolk til rydning, beskæring, ukrudtsbekæmpelse, anlæg og vedligehold.",
    svc_5_tags: "Rydning · Beskæring · Anlæg · Vedligehold",
    svc_6_title: "Mindre Håndværk",
    svc_6_desc:
      "Faglærte til mindre håndværksopgaver — reparationer, istandsættelse og vedligehold.",
    svc_6_tags: "Tømrer · Murer · VVS · Reparation",
    svc_7_title: "Byggepladsbehjælp",
    svc_7_desc:
      "Stærke hænder til byggepladsen — logistik, materialer, oprydning og support.",
    svc_7_tags: "Byggeplads · Logistik · Oprydning · Support",
    ...
    // BRANCH NAMES
    branch_1_name: "Rengøring & Oprydning",
    branch_1_sub: "Rengøring, oprydning & istandsættelse",
    branch_2_name: "Flytning & Transport",
    branch_2_sub: "Tunge løft, lastning & intern transport",
    branch_3_name: "Maling & Spartling",
    branch_3_sub: "Indendørs, facade & spartling",
    branch_4_name: "Montering & Samling",
    branch_4_sub: "Møbler, køkken, badeværelse & inventar",
    branch_5_name: "Have & Anlæg",
    branch_5_sub: "Havearbejde, beskæring & anlægsgartneri",
    branch_6_name: "Mindre Håndværk",
    branch_6_sub: "Tømrer, murer, VVS & reparationer",
    ...
    contact_price_1: "Handyman / oprydning — fra 320 kr/t",
    contact_price_2: "Maling & spartling — fra 320 kr/t",
    contact_price_3: "Havearbejde — fra 320 kr/t",
    contact_price_4: "Faglært håndværker — fra 410 kr/t",
    contact_price_5: "Specialist — fra 525 kr/t",
    ...
    contact_task_1: "Rengøring & Oprydning",
    contact_task_2: "Flytning & Transport",
    contact_task_3: "Maling & Spartling",
    contact_task_4: "Montering & Samling",
    contact_task_5: "Have & Anlæg",
    ...
    priser_how_example: "Eksempel: 175 kr løn + 145 kr gebyr =",
    priser_how_example_bold: "320 kr/t total",
    ...
    priser_tier1_worker_pay: "ca. 165–180",
    priser_tier1_total: "ca. 310–330",
    ...
    priser_tier2_worker_pay: "ca. 220–245",
    priser_tier2_total: "ca. 395–420",
    ...
    priser_tier3_worker_pay: "ca. 165–180",
    priser_tier3_total: "ca. 290–310",
  ...
  en: {
    ...
    svc_1_desc:
      "Thorough cleaning, tidying and refurbishment for homes, offices and construction sites.",
    svc_1_tags: "Cleaning · Tidying · Refurbishment · Office cleaning",
    svc_2_title: "Moving & Transport",
    svc_2_desc:
      "Help with moving, furniture transport and heavy lifting. We pack, carry and set up.",
    svc_2_tags: "Moving · Transport · Packing · Heavy lifting",
    svc_3_title: "Painting & Plastering",
    svc_3_desc:
      "Painters and assistants for all types of painting work — walls, ceilings, facades and staircases.",
    svc_3_tags: "Indoor · Facade · Plastering · Priming",
    svc_4_title: "Assembly & Mounting",
    svc_4_desc:
      "Experienced people for mounting kitchens, bathrooms, furniture and fixtures.",
    svc_4_tags: "Kitchen · Furniture · Bathroom · Fixtures",
    svc_5_title: "Garden & Landscaping",
    svc_5_desc:
      "Garden workers for clearing, pruning, weeding, landscaping and maintenance.",
    svc_5_tags: "Clearing · Pruning · Landscaping · Maintenance",
    svc_6_title: "Minor Trades",
    svc_6_desc:
      "Skilled workers for minor trade tasks — repairs, refurbishment and maintenance.",
    svc_6_tags: "Carpenter · Mason · Plumbing · Repair",
    svc_7_title: "Site Assistance",
    svc_7_desc:
      "Strong hands for the construction site — logistics, materials, cleanup and support.",
    svc_7_tags: "Site · Logistics · Cleanup · Support",
    ...
    branch_1_name: "Cleaning & Tidying",
    branch_1_sub: "Cleaning, tidying & refurbishment",
    branch_2_name: "Moving & Transport",
    branch_2_sub: "Heavy lifting, loading & transport",
    branch_3_name: "Painting & Plastering",
    branch_3_sub: "Indoor, facade & plastering",
    branch_4_name: "Assembly & Mounting",
    branch_4_sub: "Furniture, kitchen, bathroom & fixtures",
    branch_5_name: "Garden & Landscaping",
    branch_5_sub: "Gardening, pruning & landscaping",
    branch_6_name: "Minor Trades",
    branch_6_sub: "Carpenter, mason, plumbing & repairs",
    ...
    contact_price_1: "Handyman / cleanup — from DKK 320/h",
    contact_price_2: "Painting & plastering — from DKK 320/h",
    contact_price_3: "Garden work — from DKK 320/h",
    contact_price_4: "Skilled tradesman — from DKK 410/h",
    contact_price_5: "Specialist — from DKK 525/h",
    ...
    contact_task_1: "Cleaning & Tidying",
    contact_task_2: "Moving & Transport",
    contact_task_3: "Painting & Plastering",
    contact_task_4: "Assembly & Mounting",
    contact_task_5: "Garden & Landscaping",
    ...
    priser_how_example: "Example: DKK 175 wage + DKK 145 fee =",
    priser_how_example_bold: "DKK 320/hr total",
    ...
    priser_tier1_worker_pay: "approx. 165–180",
    priser_tier1_total: "approx. 310–330",
    ...
    priser_tier2_worker_pay: "approx. 220–245",
    priser_tier2_total: "approx. 395–420",
    ...
    priser_tier3_worker_pay: "approx. 165–180",
    priser_tier3_total: "approx. 290–310",
